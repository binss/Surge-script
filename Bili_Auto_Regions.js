...
const TW = $persistentStore.read('BiliArea_TW') || 'Proxy-TW'; //Your Taiwan sub-policy name.
const HK = $persistentStore.read('BiliArea_HK') || 'Proxy-HK'; //Your HongKong sub-policy name.
